...
registry_version: 0.11.1-wbs055-taxonomy
...
EQ-PRICE-001,ADMIN,Administered prices WP239 shock and price-rule parameters,structural,LM-PRICE-ADMIN-001,BCB_WP239,WP239 Section 2.5 Shocks PDF page 38; Appendix C.6 PDF page 92; administered prices shock equation C.58; Table 3 PDF page 98 administered price rule parameters,pi_a|admin_price_shock_state|delta_q|mc,rho_admin|alpha_a_fx|alpha_a_mc,eps_admin,admin_process_own_equation;admin_shock_ar1_present;fx_coefficient_sourced;marginal_cost_coefficient_sourced;target_and_imported_pass_through_not_required_for_wp239_mvp;eps_admin_declared;not_generic_shock,sourced,WBS-038,Canonical persistence is rho_admin. Legacy rho_a and alpha_a_m are tracked as aliases or not required for the classic WP239 MVP.
